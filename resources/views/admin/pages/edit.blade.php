<x-admin-layout>
      ...
      <div class="row align-items-center">
        <div class="col-md-12">
          ...
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#!">{{__('admin.EditPage')}}</a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-sm-12">
      <form action="{{url('admin/pages/' . $page->id)}}" method="POST" novalidate>
        @csrf
        @method('PUT')
        <div class="card">
          <div class="card-header">
            <h5>{{__('admin.EditPage')}}</h5>
          </div>
          <div class="card-body">
                ...
                <div class="row">
                  <div class="col col-8">
                    <div class="form-group">
                      ...
                      <input type="text" name="title" value="{{old('title') ?? $page->title}}" class="form-control" id="inputTitle" placeholder="{{__('admin.InsertTitle')}}" autofocus>
                      @if($errors->has('title'))
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="slug" value="{{old('slug') ?? $page->slug}}" class="form-control" id="inputSlug" placeholder="{{__('admin.InsertSlug')}}">
                      @if($errors->has('slug'))
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="subtitle" value="{{old('subtitle') ?? $page->subtitle}}" class="form-control" id="inputSubtitle" placeholder="{{__('admin.InsertSubtitle')}}">
                      @if($errors->has('subtitle'))
                      <div class="invalid-feedback d-block">{{$errors->first('subtitle')}}</div>
                      @endif
                    </div>
                    <div class="form-group">
                      <label for="inputText">{{__('admin.Text')}}</label>
                      <textarea id="inputText" name="text" class="form-control hasEditor">{{$page->text}}</textarea>
                    </div>
                  </div>
                  <div class="col col-4">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <div class="custom-control custom-checkbox">
                        <input type="checkbox" name="status" @checked(old('status', $page->status)) class="custom-control-input" id="customCheckStatus">
                    ...
                    <div class="form-group">
                      ...
                      <select name="lang" class="form-control" id="inputLanguage">
                        ...
                        <option value="{{$lang->value}}" @selected(old('lang') ?? $page->lang == $lang->value)>{{$lang->name}}</option>
                        @endforeach
                      </select>
                    </div>
                    <div class="form-group">
                      <label for="inputSort">{{__('admin.Sort')}}</label>
                      <input type="number" name="sort" step="1" min="1" value="{{old('sort') ?? $page->sort}}" class="form-control" id="inputSort">
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col col-8" id="wrapperCustom">
                    ...
                    if( !empty($page->custom) ) {
                      $custom = json_decode($page->custom);
                    }
                    $index = 0;
                    @endphp
                ...
                <div class="row">
                  <div class="col col-8">
                    <div class="form-group">
                      ...
                      <input type="text" name="metatitle" class="form-control" value="{{old('metatitle') ?? $page->metatitle}}" id="inputMetatitle" placeholder="{{__('admin.InsertMetatitle')}}">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="keywords" class="form-control" value="{{old('keywords') ?? $page->keywords}}" id="inputKeywords" placeholder="{{__('admin.InsertKeywords')}}">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="description" class="form-control" value="{{old('description') ?? $page->description}}" id="inputDescription" placeholder="{{__('admin.InsertDescription')}}">
