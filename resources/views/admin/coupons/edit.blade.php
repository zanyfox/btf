...
<x-admin-layout>
      ...
      <div class="row align-items-center">
        <div class="col-md-12">
          ...
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#!">@lang('admin.EditCoupon')</a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-sm-12">
      ...
      @endif
      <form action="{{route('admin.coupons.update', $coupon->id)}}" method="POST" id="editCouponForm" novalidate>
        @csrf
        @method('PUT')
        <div class="card">
          <div class="card-header">
            <h5>@lang('admin.EditCoupon')</h5>
          </div>
          <div class="card-body">
            <div class="row">
              <div class="col col-8">
                <div class="form-group">
                  ...
                  <input type="text" name="code" value="{{old('code') ?? $coupon->code}}" class="form-control" id="inputCode" autocomplete="code" autofocus placeholder="@lang('admin.CouponCode')">
                  <div class="d-block"></div>
                </div>
                <div class="form-group">
                  <label for="inputName">@lang('admin.CouponName')</label>
                  <input type="text" name="name" value="{{old('name') ?? $coupon->name}}" class="form-control" id="inputName" placeholder="@lang('admin.CouponName')">
                </div>
                <div class="form-group">
                  <label for="inputDescription">@lang('admin.Description')</label>
                  <textarea id="inputDescription" name="description" rows="6" class="form-control">{{old('description') ?? $coupon->description}}</textarea>
                </div>
                <div class="row">
                  <div class="form-group col-md-6">
                    <label for="inputStartedAt">@lang('admin.StartsAt')</label>
                    <input type="date" name="started_at" value="{{old('started_at') ?? $coupon->started_at}}" class="form-control" id="inputStartedAt" autocomplete="off">
                    <div class="d-block"></div>
                  </div>
                  <div class="form-group col-md-6">
                    <label for="inputExpiredAt">@lang('admin.ExpiresAt')</label>
                    <input type="date" name="expired_at" value="{{old('expired_at') ?? $coupon->expired_at}}" class="form-control" id="inputExpiredAt" autocomplete="off">
                    <div class="d-block"></div>
                  </div>
                </div>
              </div>
              <div class="col col-4">
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="value" value="{{old('value') ?? $coupon->value}}" class="form-control" id="inputCouponValue">
                  <div class="d-block"></div>
                </div>
                <div class="form-group">
                  <label for="inputMinSum">@lang('admin.MinSum')</label>
                  <input type="number" name="min_sum" value="{{old('min_sum') ?? $coupon->min_sum}}" class="form-control" id="inputMinSum">
                </div>
                <div class="form-group">
