<x-admin-layout>
      ...
      <div class="row align-items-center">
        <div class="col-md-12">
          ...
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ url('admin/types') }}">{{__('admin.Types')}}</a></li>
            <li class="breadcrumb-item"><a href="#!">{{__('admin.CreateType')}}</a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-sm-12">
      <form action="{{url('admin/types')}}" method="POST" id="typeForm" novalidate>
        @csrf
        <div class="card">
          <div class="card-header">
            <h5>{{__('admin.CreateType')}}</h5>
          </div>
          <div class="card-body">
            <div class="row">
              <div class="col col-8">
