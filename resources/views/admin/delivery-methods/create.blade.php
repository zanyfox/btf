<x-admin-layout>
  <x-slot name="title">@lang('admin.CreateDeliveryMethod')</x-slot>
      ...
      <div class="row align-items-center">
        <div class="col-md-12">
          ...
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#!">@lang('admin.CreateDeliveryMethod')</a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-sm-12">
      <form action="{{url('admin/delivery-methods')}}" method="POST" id="DeliveryMethodForm" novalidate>
        @csrf
        <div class="card">
          <div class="card-header">
            <h5>@lang('admin.CreateDeliveryMethod')</h5>
          </div>
          <div class="card-body">
            <div class="row">
              <div class="col col-8">
  ...
  <script>
    ...
    DeliveryMethodForm.onsubmit = function(event) {
      ...
      const url = DeliveryMethodForm.getAttribute('action')
      submitBtn.setAttribute('disabled', true)
      fetch(url, {
        method: 'POST',
        headers: {
