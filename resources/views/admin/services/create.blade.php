<x-admin-layout>
      ...
      <div class="row align-items-center">
        <div class="col-md-12">
          ...
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#!">@lang('admin.CreateRecord')</a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-sm-12">
      <form action="{{url('admin/services')}}" method="POST" enctype="multipart/form-data" novalidate>
        @csrf
        <div class="card">
          <div class="card-header">
            <h5>@lang('admin.CreateRecord')</h5>
          </div>
          <div class="card-body">
                ...
                <div class="row">
                  <div class="col col-8">
                    <div class="form-group">
                      ...
                      <input name="name" value="{{old('name')}}" class="form-control" id="inputName" placeholder="@lang('admin.InsertName')" autofocus>
                      @if($errors->has('name'))
                    ...
                    <div class="form-group">
                      ...
                      <input name="slug" value="{{old('slug')}}" class="form-control" id="inputSlug" placeholder="@lang('admin.InsertSlug')">
                      @if($errors->has('slug'))
                    ...
                    <div class="form-group">
                      ...
                      <input name="tagline" value="{{old('tagline')}}" class="form-control" id="inputTagline" placeholder="@lang('admin.InsertTagline')">
                    </div>
                    <div class="form-group">
                      <label for="inputBody">@lang('admin.Body')</label>
                      <textarea id="inputBody" name="body" class="form-control hasEditor">{{old('body')}}</textarea>
                    </div>
                  </div>
                  <div class="col col-4">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" name="price" value="{{old('price')}}" class="form-control" id="inputPrice">
                    </div>
                    <div class="form-group">
                      <label for="inputOrderBy">@lang('admin.OrderBy')</label>
                      <input type="number" name="order_by" step="1" min="1" value="{{old('order_by') ?? 1}}" class="form-control" id="inputOrderBy">
                    </div>
                ...
                <div class="row">
                  <div class="col col-8">
                    <div class="form-group">
                      ...
                      <input type="text" name="metatitle" class="form-control" value="{{old('metatitle')}}" id="inputMetatitle" placeholder="@lang('admin.InsertMetatitle')">
                    ...
                    <div class="form-group">
                      <label for="inputKeywords">@lang('admin.Keywords')</label>
                      <input type="text" name="keywords" class="form-control" value="{{old('keywords')}}" id="inputKeywords" placeholder="@lang('admin.InsertKeywords')">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="description" class="form-control" value="{{old('description')}}" id="inputDescription" placeholder="@lang('admin.InsertDescription')">
