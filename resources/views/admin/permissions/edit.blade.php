<x-admin-layout>
  <x-slot name="title">@lang('admin.EditPermission')</x-slot>
      ...
      <div class="row align-items-center">
        <div class="col-md-12">
          ...
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#!">@lang('admin.EditPermission')</a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-sm-12">
      <form action="{{url('admin/permissions/' . $permission->id)}}" method="POST" id="permissionForm" novalidate>
        @csrf
        @method('PUT')
        <div class="card">
          <div class="card-header">
            <h5>@lang('admin.EditPermission')</h5>
          </div>
          <div class="card-body">
            <div class="row">
              <div class="col col-8">
                <div class="form-group">
                  ...
                  <input type="text" name="name" value="{{$permission->name}}" class="form-control" id="inputName">
