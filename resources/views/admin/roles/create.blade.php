<x-admin-layout>
  <x-slot name="title">@lang('admin.CreateRole')</x-slot>
      ...
      <div class="row align-items-center">
        <div class="col-md-12">
          ...
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#!">@lang('admin.CreateRole')</a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-sm-12">
      <form action="{{url('admin/roles')}}" method="POST" id="roleForm" novalidate>
        @csrf
        <div class="card">
          <div class="card-header">
            <h5>@lang('admin.CreateRole')</h5>
          </div>
          <div class="card-body">
            <div class="row">
              <div class="col col-8">
