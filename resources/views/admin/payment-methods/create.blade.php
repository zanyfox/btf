<x-admin-layout>
  <x-slot name="title">@lang('admin.CreatePaymentMethod')</x-slot>
      ...
      <div class="row align-items-center">
        <div class="col-md-12">
          ...
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#!">@lang('admin.CreatePaymentMethod')</a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-sm-12">
      <form action="{{url('admin/payment-methods')}}" method="POST" id="paymentMethodForm" novalidate>
        @csrf
        <div class="card">
          <div class="card-header">
            <h5>@lang('admin.CreatePaymentMethod')</h5>
          </div>
          <div class="card-body">
            <div class="row">
              <div class="col col-8">
                ...
                <div class="form-group">
                  ...
                  <textarea name="code" class="form-control" id="inputDescription"></textarea>
                </div>
              </div>
              <div class="col col-4">
                <div class="form-group mt-4">
                  <div class="custom-control custom-checkbox">
                    <input type="checkbox" name="status" class="custom-control-input" id="inputStatus">
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="sort" class="form-control" id="inputSort">
                </div>
              </div>
            </div>
          </div>
        ...
        <button type="button" data-url="{{ url('admin/payments-methods') }}" onclick="if(!confirm('Вы уверены, что хотите отменить изменения?')) {return false} else {window.location.href = this.dataset.url}" class="ml-3 btn btn-outline-warning">@lang('admin.Cancel')</button>
      </form>
    </div>
  </div>
  @push('scripts')
  <script>
    ...
    paymentMethodForm.onsubmit = function(event) {
      ...
      const url = paymentMethodForm.getAttribute('action')
      submitBtn.setAttribute('disabled', true)
      fetch(url, {
        method: 'POST',
        headers: {
