  ...
  <div class="container">
    ...
    <div class="row modern-residential_img">
      <div class="col-xxl-12 position-relative">
        <div class="main_menu">
          <img class="img-fluid w-100" src="{{asset('assets/img/3d-rendering-wooden-country-house.png')}}">
        </div>
        ...
        <img class="icon_camera_country_house icon_camera_cursor" src="{{asset('assets/img/icon_camera.svg')}}"
              onclick="icon_camera_click()" title="Умная камера" alt="Умная камера">
        <img class="vector_camera_country_house" src="{{asset('assets/img/vector_camera_country_house.svg')}}">
      </div>
    </div>
