  ...
  <div class="container">
    ...
    <div class="row modern-residential_img">
      <div class="col-xxl-12 position-relative">
        <div class="main_menu">
          <img class="img-fluid w-100" src="{{ url('assets/img/3d-rendering-wooden-construction.png') }}">
        </div>
        <img class="img-fluid monitor_of_construction" src="{{ url('assets/img/monitor_of_construction.png') }}">
        ...
        <img class="icon_camera_construction icon_camera_cursor" src="{{ url('assets/img/icon_camera.svg') }}"
              onclick="icon_camera_click()" title="Умная камера" alt="Умная камера">
        <img class="vector_camera_counstruction" src="{{ url('assets/img/vector_construction.svg') }}">
      </div>
    </div>
