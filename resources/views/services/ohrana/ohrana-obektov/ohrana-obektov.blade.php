...
<div class="container">
    ...
    <div id="mainCarousel" class="carousel slide" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active" data-title="{{ $service->name }}" data-subtitle="{{ $service->tagline }}">
          <picture>
            <source media="(max-width: 768px)" srcset="{{asset('assets/img/ohrana-obektov_mob.jpg')}}">
            <img src="{{asset('assets/img/ohrana-obektov.jpg')}}" class="w-100" loading="eager" decoding="sync" fetchpriority="high" alt="">
          </picture>
        </div>
      </div>
    </div>
    ...
    <div class="row g-5 justify-content-between">
      ...
      <div class="col-xxl-4">
        <div class="button_image">
          <a href="{{ url('ohrana-obektov', $child->slug ) }}" class="blur">
            <p>{{ $child->name }}</p>
            <span>ПОДРОБНЕЕ</span>
          </a>
  ...
  @isset($custom['text-3'])
  <div class="text text-3 mb-100">
    <h4 class="page-subheader mb-4">{{ $custom['text-3']->title }}</h4>
    {!! $custom['text-3']->body !!}
  </div>
  @endisset
  ...
  @isset($custom['text-4'])
  <div class="text text-4 mb-100">
    <h4 class="page-subheader mb-4">{{ $custom['text-4']->title }}</h4>
    {!! $custom['text-4']->body !!}
  </div>
  @endisset
