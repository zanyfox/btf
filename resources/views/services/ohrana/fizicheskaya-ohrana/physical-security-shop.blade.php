...
<section class="mb-5 grandchild-service grandchild-service-{{$service->slug}}">
    <div class="container">
      ...
      <div class="mb-100 mobile_disable_360">
        <img class="img-fluid" src="{{ asset('assets/img/physical_security_shop_content_img.png') }}">
      </div>
    </div>
    <div class="mb-100 mobile_enable_360">
      <img class="img-fluid" src="{{ asset('assets/img/physical_security_shop_content_img_mobile.png') }}">
    </div>
    <div class="container">
