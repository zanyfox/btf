...
<section class="mb-5 grandchild-service grandchild-service-{{$service->slug}}">
  <div class="container">
    ...
    <div class="row mb-100 mobile_disable_360">
      <div class="col-xxl-12">
        <img class="img-fluid" src="{{ asset('assets/img/physical_security_bisnines_center_content_img.png') }}">
      </div>
    </div>
  </div>
    <div class="row mb-100 mobile_enable_360">
      <div class="col-xxl-12">
        <img class="img-fluid" src="{{ asset('assets/img/physical_security_bisnines_center_content_img_mobile.png') }}">
      </div>
    </div>
    <div class="container">
      <div class="main_menu pb-0">
        <div class="row g-5">
          <div class="col-xxl-6 col-md-12 mb-3 mb-xxl-0">
            @isset($custom['text-1'])
          ...
          <div class="col-xxl-6 col-md-12 mb-5 mb-xxl-0">
            @isset($custom['text-2'])
