    ...
    <div class="main_menu pt-0 pb-0 pe-0">
      <div class="row bg_security_measures">
        ...
        <div class="col-xl-6 mobile_disable_1200">
          <img class="img-fluid h-100" src="{{ asset('assets/img/security_banks_img_content.png') }}">
        </div>
      </div>
    </div>
  </div>
  <div class="mobile_enable_1200 text-center">
    <img class="img-fluid" src="{{ asset('assets/img/security_banks_img_content_mobile.png') }}">
  </div>
  <div class="event_security_bg_red">
    <div class="container p_0_pixles">
      <div class="main_menu pt-0 pb-0 ps-0 ">
        <div class="row">
          <div class="col-xl-6 mobile_disable_1200">
            <img class="img-fluid h-100" src="{{ asset('assets/img/event_security_banks_content.png') }}">
          </div>
          <div class="col-xl-6 pl-event_security pt-40">
    ...
    <div class="mobile_enable_1200 text-center">
      <img class="img-fluid" src="{{ asset('assets/img/event_security_banks_content_mobile.png') }}">
    </div>
  </div>
