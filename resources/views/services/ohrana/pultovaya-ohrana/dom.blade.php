  ...
  <div class="container">
    ...
    <div class="row modern-residential_img">
      <div class="col-xxl-12 position-relative">
        <div class="main_menu">
          <img class="img-fluid w-100" src="{{asset('assets/img/modern-residential-district.png')}}">
        </div>
        ...
        <img class="icon_camera icon_camera_cursor" src="{{asset('assets/img/icon_camera.svg')}}" onclick="icon_camera_click()" title="Умная камера" alt="Умная камера">
        <img class="vector_camera" src="{{asset('assets/img/vector_camera.svg')}}">
      </div>
    </div>

    <div class="row mb-100 g-5">
      <div class="col-lg-6">
