...
<section class="grandchild-service grandchild-service-{{$service->slug}}">
  <div class="container">
    ...
    <div class="row modern-residential_img">
      <div class="col-xxl-12 position-relative">
        <div class="main_menu">
          <img class="img-fluid w-100" src="{{ asset('assets/img/3d-rendering-wooden-business-centers.png') }}">
        </div>
        <img class="img-fluid monitor_of_parking" src="{{ asset('assets/img/monitor_of_parking.svg') }}">
        ...
        <img class="icon_camera_business_centers icon_camera_cursor" src="{{ asset('assets/img/icon_camera.svg') }}"
              onclick="icon_camera_click()" title="Умная камера" alt="Умная камера">
        <img class="vector_camera_business_centers" src="{{ asset('assets/img/vector_business_centers.svg') }}">
      </div>
    </div>
  ...
  <div class="container mb-100">
    <h4 class="page-subheader mb-5">цены на услуги охраны организаций:</h4>
    <div class="row">
      <div class="col-12">
