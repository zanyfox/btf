...
<div class="container">
    ...
    <div id="mainCarousel" class="carousel slide" data-bs-ride="carousel">
      <h3 id="mainCarouselTitle" class="mb-30">{{ $service->name }}</h3>
      ...
      <div class="carousel-inner">
        <div class="carousel-item active" data-title="{{ $service->name }}" data-subtitle="{{ $service->tagline }}">
          <picture>
            <source media="(max-width: 768px)" srcset="{{asset('assets/img/ohrana-organizatsiy_mob.jpg')}}">
            <img src="{{asset('assets/img/ohrana-organizatsiy.jpg')}}" class="w-100" loading="eager" decoding="sync" fetchpriority="high" alt="">
          </picture>
        </div>
      </div>
    </div>
    ...
    <div class="row g-5 justify-content-between">
      ...
      <div class="col-xxl-4">
        <div class="button_image">
          <a href="{{ url('ohrana-organizatsiy', $child->slug ) }}" class="blur">
            <p>{{ $child->name }}</p>
            <span>ПОДРОБНЕЕ</span>
          </a>
