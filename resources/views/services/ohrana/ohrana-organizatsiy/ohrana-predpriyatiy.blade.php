  ...
  <div class="container">
    ...
    <div class="row modern-residential_img">
      <div class="col-xxl-12 position-relative">
        <div class="main_menu">
          <img class="img-fluid w-100" src="{{ asset('assets/img/3d-rendering-wooden-enterprises.png') }}">
        </div>
        <img class="img-fluid monitor_of_construction" src="{{ asset('assets/img/monitor_of_construction.png') }}">
        ...
        <img class="icon_camera_construction icon_camera_cursor" src="{{ asset('assets/img/icon_camera.svg') }}"
              onclick="icon_camera_click()" title="Умная камера" alt="Умная камера">
        <img class="vector_camera_counstruction" src="{{ asset('assets/img/vector_construction.svg') }}">
      </div>
    </div>
