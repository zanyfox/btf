                ...
                <div class="table-responsive">
                  <table class="table table-hover">
                    <tbody>
                      <tr class="unread">
                        <td
                          ><img class="rounded-circle" style="width: 40px" src="/assets/backend/images/user/avatar-1.jpg" alt="activity-user"
                        /></td>
                        <td>
                      ...
                      <tr class="unread">
                        <td
                          ><img class="rounded-circle" style="width: 40px" src="/assets/backend/images/user/avatar-2.jpg" alt="activity-user"
                        /></td>
                        <td>
                      ...
                      <tr class="unread">
                        <td
                          ><img class="rounded-circle" style="width: 40px" src="/assets/backend/images/user/avatar-3.jpg" alt="activity-user"
                        /></td>
                        <td>
        ...
        <div class="row">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <div class="d-flex justify-content-between">
                  ...
                  <select v-model="selectedMessageStatus" @change="getMessagesCount()" style="height: 2rem; outline: 2px solid transparent;" class="px-1 rounded border-0">
                    <option value="all">All</option>
                    <option value="scheduled">New</option>
                    <option value="confirmed">Read</option>
                    <option value="cancelled">Done</option>
                  </select>
                </div>
                <p>Messages</p>
              </div>
              ...
              <router-link to="/backend/messages" class="small-box-footer">
          ...
          <div class="col-lg-3 col-6">
            <div class="small-box bg-info">
              ...
              <router-link to="/backend/users" class="small-box-footer">
...
const selectedMessageStatus = ref('all')
...
const getMessagesCount = () => {
  axios.get('/api/backend/messages/count', {
    params: {
      status: selectedMessageStatus.value
    }
  }).then(response => {
    console.log('getMessagesCount', response.data.counts)
    //totalMessagesCount.value = response.data.count
  })
}
...
const getTotalCounts = () => {
  axios.get('/api/dashboard/counts')
    .then(response => {
      totalAppointmentsCount.value = response.data.total_appointments_count
      totalUsersCount.value = response.data.total_users_count
    })
}
const getCounts = () => {
  getMessagesCount()
