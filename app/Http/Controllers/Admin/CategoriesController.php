...
class CategoriesController extends Controller {
  ...
  public function store(Request $request) {
    ...
    if( $category->save() ) {
      $request->session()->flash('success', __('admin.RecordHasBeenCreated'));
      return response()->json([
        'status' => 'success',
  ...
  public function update(Request $request, int $id) {
    ...
    $validator = Validator::make($request->all(), [
      'name' => 'required|string|min:3|max:255',
      'slug' => 'required|string|min:3|max:255|unique:categories,slug, '. $category->id .',id'
    ]);
  ...
  public function changeStatus(int $id) {
    ...
    $category->save();
    return redirect()->back()->with('success', __('admin.RecordStatusChanged'));
  }
  ...
  public function destroy(int $id) {
    ...
    /* if($category->goods()) {
      session()->flash('fail', 'Category has goods');
      return response()->json([
        'status' => 'fail',
